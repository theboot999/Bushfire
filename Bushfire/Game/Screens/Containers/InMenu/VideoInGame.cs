...
{
    class VideoInGame : Video
    {
        public VideoInGame() : base(new Rectangle(800, 100, 900, 1100), DockType.CENTERSCREENBOTH)
        {
            spriteBack = GraphicsManager.GetPreBuilt(Engine.ContentStorage.PrebuiltSprite.InGameMenuBack);
            AddBorder(2, Resizing.NONE, 20);
            AddUiControl(new ButtonBlueLarge("Back", new Point(150, 860), "Back", Color.White));
